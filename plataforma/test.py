...
class Usuario:
     def __init__(self, nombre, email):
          self.nombre = nombre
          self.email = email
          self.cuentas_bancarias = []  # Lista de cuentas bancarias del usuario

     def agregar_cuenta_bancaria(self, cuenta):
...
# Agregamos las cuentas bancarias al usuario
usuario.agregar_cuenta_bancaria(cuenta1)
usuario.agregar_cuenta_bancaria(cuenta2)

# Mostramos las cuentas bancarias del usuario
usuario.mostrar_cuentas_bancarias()
